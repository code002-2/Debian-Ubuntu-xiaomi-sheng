# 警告
我们不对以下情况负责：变砖的设备、丢失的恢复分区、死掉的小米流水线工人和牛仔、损坏的存储卡、损坏的电源管理芯片、损坏的内存、损坏的显示驱动芯片、损坏的CPU、任何小米的骚操作、死掉的猫狗、核战争，或者因为你忘记切回安卓系统而导致闹钟没响被炒鱿鱼。
